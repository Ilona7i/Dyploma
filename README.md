...
[Версія 1.0 — Фінальна версія бакалаврської роботи](https://github.com/Ilona7i/Dyploma/releases/tag/v1.0.0)
...
4. **Кошик** — перегляньте обрані позиції та оформте замовлення
